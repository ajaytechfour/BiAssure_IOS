//
//  ModelShowViewController.swift
//  BiAssure
//
//  Created by Swetha on 01/08/19.
...
class ModelShowViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UIPickerViewDelegate,UIPickerViewDataSource,SSMaterialCalendarPickerDelegate,ChartViewDelegate {
    ...
    @IBOutlet weak var btnAllModel: UIButton!
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        {
            btnAllModel.isUserInteractionEnabled = false
        }
        else
        {
            btnAllModel.isUserInteractionEnabled = true
        }
    ...
    @IBAction func btnAllModels_didSelect(_ sender:UIButton)
    {
        let selectAction = RMAction(title: "Select", style: RMActionStyle.done, andHandler: { controller in
            ...
            RegionDetailViewController.strRegionModel = "Modelwise"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if tableView == tblModelShow
        {
            ...
            else
            {
                ...
                configurePieChart(pieChart: pieChartOEM, arrchart: arrRegionSales)
                return cell
            }
        }
        else
